...
function addlogo()
{
	...
	$y1  = 20;
	$this->SetXY($x1,$y1);
	$this->Image(dirname(__FILE__).'/img/ajav.jpg',11,8,25.5,25.5);
...
function addjvm()
{
	...
	$y1  = 20;
	$this->SetXY($x1,$y1);
	$this->Image(dirname(__FILE__).'/img/jvm.jpg',38,4,160,14);
...
function addGrandTotal($no)
{
	$this->SetXY(14,140);
	$this->SetFont('Arial','B',9);
	$this->Cell(149,5,"Grand Total",1,1,'L');
	$this->SetXY(163,140);
	$this->SetFont('Arial','B',9);
...
function addstamp()
{
	...
	$this->Image(dirname(__FILE__).'/img/jadi.jpg',132,219,25,25);
...
{
    // Logo                                       x,y,gede
    $this->Image(dirname(__FILE__).'/img/ajav.jpg',15,12,18);
    // Arial bold 15
...
function lefttopinv(){
	/*$this->Image(dirname(__FILE__).'/img/jvm.jpg',14,35,40);
	$this->SetFont('Arial','',9);
	$this->SetXY(19,40);
...
function isi_cusside($nm,$almt,$telp){
	
	$this->SetFont('Arial','',8);
	$this->SetXY(14,71);
	$this->Cell(35,3,$nm,0,0,'L');
	$this->SetXY(14,75);
	$this->Multicell(35,3.5,$almt.'dksjdkjsd dkajdksjdskadjsakdjs sjd sadjsakdjska',0);
	$this->SetXY(14,90);
	$this->Multicell(35,3.5,$telp,0);
	//$this->Image(dirname(__FILE__).'/img/barcodee.JPG',13.5,94.5,45,6.5);
}
function isi_billside($almt){
	$this->SetFont('Arial','',8);
	$this->SetXY(75,71);
	$this->Multicell(50,3.5,$almt,0,'L');
}
function isi_shipside($almt){
	$this->SetFont('Arial','',8);
	$this->SetXY(130,71);
	$this->Multicell(50,3.5,$almt,0,'L');
}
